 ...
 * Generated at: 2017-03-08 23:39:36 UTC
...
java.text.DateFormat dft = new java.text.SimpleDateFormat("E yyyy.MM.dd 'at' hh:mm:ss a "); 
      ...
      out.write("\t\t\t\t\t\t<form id=\"myForm\" action=\"kennyLoggins\" method=\"post\" class=\"bs-example form-horizontal\">\r\n");
      out.write("\t\t\t\t\t\t\t<fieldset>\r\n");
      out.write("\t\t\t\t\t\t\t\t<legend>wellness club login </legend><br>\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<label for=\"userNameInput\" class=\"col-lg-3 control-label\">Email</label>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"col-lg-9\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<input type=\"text\" class=\"form-control\" name=\"emailAddress\" id=\"emailAddress\" placeholder=\"User Name\" />\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<a href=\"forgotpassword\" class=\"btn btn-primary\" role=\"button\">Forgot Password</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\t\r\n");
      out.write("\t\t\t\t\t\t\t</fieldset>\r\n");
      out.write("\t\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t</div>\r\n");
